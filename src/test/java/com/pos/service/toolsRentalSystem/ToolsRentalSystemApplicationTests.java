...
class ToolsRentalSystemApplicationTests {
    ...
    void createFloatingHolidayTest() throws Exception {
        FloatingDateHoliday holiday = FloatingDateHoliday.builder()
                .name("Labor Day")
        ...
        ResultActions response = mockMvc.perform(post("/holiday/create/floatingDateHoliday")
        ...
        response.andDo(print()).
                ...
                .andExpect(jsonPath("$.name",
                        is(holiday.getName())))
                .andExpect(jsonPath("$.weekDay",
                        is(holiday.getWeekDay())))
                .andExpect(jsonPath("$.weekNumber",
                        is(holiday.getWeekNumber())))
    ...
    void createFixedHolidayTest() throws Exception {
        FixedDateHoliday holiday = FixedDateHoliday.builder()
        ...
        ResultActions response = mockMvc.perform(post("/holiday/create/fixedDateHoliday")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(holiday)));
        response.andDo(print()).
                andExpect(status().isCreated())
                ...
                .andExpect(jsonPath("$.month",
                        is(holiday.getMonth())))
                .andExpect(jsonPath("$.isObservedHoliday",
                        is(holiday.getIsObservedHoliday())));
    }
    ...
    private void testToolTypeCreation(ToolType toolType) throws Exception {
        ResultActions response = mockMvc.perform(post("/toolType/create")
                .contentType(MediaType.APPLICATION_JSON)
        ...
        response.andDo(print()).
                ...
                .andExpect(jsonPath("$.name",
                        is(toolType.getName())))
                .andExpect(jsonPath("$.dailyCharge",
                        is(toolType.getDailyCharge().doubleValue())))
                .andExpect(jsonPath("$.weekdayCharge",
                        is(toolType.getWeekdayCharge())))
                .andExpect(jsonPath("$.weekendCharge",
                        is(toolType.getWeekendCharge())))
                .andExpect(jsonPath("$.holidayCharge",
                        is(toolType.getHolidayCharge())));
    }
    ...
    private void testToolCreation(JSONObject tool) throws Exception {
        ResultActions response = mockMvc.perform(post("/tool/create")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void createRentalAgreementTest1() throws Exception {
        ...
        ResultActions response = mockMvc.perform(post("/rentalAgreement/checkout")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    private void testRentalAgreementCreation(JSONObject rentalAgreement,
                                             ...
                                             Object expectedPreDiscountChargeFormatted, Object expectedDiscountPercentFormatted, Object expectedDiscountAmountFormatted, Object expectedFinalChargeFormatted) throws Exception {
        ResultActions response = mockMvc.perform(post("/rentalAgreement/checkout")
                .contentType(MediaType.APPLICATION_JSON)
                .content(rentalAgreement.toString()));
        response.andDo(print()).
                andExpect(status().isCreated())
                .andExpect(jsonPath("$.tool.code",
                        is(rentalAgreement.get("toolCode"))))
                .andExpect(jsonPath("$.discountPercent",
                        is(rentalAgreement.get("discountPercent"))))
                .andExpect(jsonPath("$.rentalDayCount",
                        is(rentalAgreement.get("rentalDayCount"))))
                .andExpect(jsonPath("$.checkoutDate",
                        is(rentalAgreement.get("checkoutDate"))))
                .andExpect(jsonPath("$.dueDate",
                        is(expectedDueDate)))
                .andExpect(jsonPath("$.chargeDays",
                        is(expectedChargeDays)))
                .andExpect(jsonPath("$.preDiscountCharge",
                        is(expectedPreDiscountCharge)))
                .andExpect(jsonPath("$.discountAmount",
                        is(expectedDiscountAmount)))
                .andExpect(jsonPath("$.finalCharge",
                        is(expectedFinalCharge)))
                .andExpect(jsonPath("$.preDiscountChargeFormatted",
                        is(expectedPreDiscountChargeFormatted)))
                .andExpect(jsonPath("$.discountPercentFormatted",
                        is(expectedDiscountPercentFormatted)))
                .andExpect(jsonPath("$.discountAmountFormatted",
                        is(expectedDiscountAmountFormatted)))
                .andExpect(jsonPath("$.finalChargeFormatted",
                        is(expectedFinalChargeFormatted)));
    }
    ...
    void createRentalAgreementTest2() throws Exception {
        ...
        testRentalAgreementCreation(rentalAgreement,
                "7/4/20",
                2,
                3.98,
                0.4,
